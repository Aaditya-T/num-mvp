...
import { Sparkles, Printer, Copy, RotateCcw, Phone } from 'lucide-react';
      ...
      <main className="main-content">
        ...
        {formData && (
          <section id="results-section" className="results-container">
            ...
            {/* Restricted / Blurred Second Half */}
            <div className="restricted-report-wrapper">
              <div className="restricted-blur-overlay hide-on-print">
                <div className="restricted-message-card">
                  <span className="restricted-icon">🔒</span>
                  <h3>Complete Report Locked</h3>
                  <p>Get missing numbers analysis, repeated numbers effects, grid plane strengths, and personalized remedies.</p>
                  <button 
                    onClick={() => setIsContactOpen(true)} 
                    className="btn btn-primary btn-gold"
                  >
                    Contact Us for Further Readings
                  </button>
                </div>
              </div>
              
              <div className="restricted-content-blur">
